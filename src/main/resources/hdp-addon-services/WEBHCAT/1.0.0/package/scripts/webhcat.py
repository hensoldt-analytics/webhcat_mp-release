...
def webhcat():
  ...
  # HACK setting hive as name so the function will not return due to service not present.
  # PIG package is installed by webhcat, so the tar.gz file will be present on the host.
