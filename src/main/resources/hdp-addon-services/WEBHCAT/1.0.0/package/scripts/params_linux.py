...
pig_tar_dest_file = "/{0}/pig.tar.gz".format(webhcat_apps_dir)
...
webhcat_user = config['configurations']['webhcat-env']['webhcat_user']

hcat_pid_dir = status_params.hcat_pid_dir
hcat_log_dir = config['configurations']['webhcat-env']['hcat_log_dir']
...
templeton_log_dir = config['configurations']['webhcat-env']['hcat_log_dir']
